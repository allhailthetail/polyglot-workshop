...
- Hardware longevity
  ...
  My PC is 5+ years old, runs great on RPi's also, exp rev5.
...
** Day 1 What I wish I'd have known
  ...
  FAIR DISCLAIMER: you'll spend several days/weeks learning to navigate and remember where things are by using =C-h=...
...
** Day 2 - Learning the terminology
*** Theory of Movement
1) Frame (windows)
   - Window (frames)
     Splitting windows:
...
*** Killing and Yanking Text (Copy/Paste)
#+begin_quote
